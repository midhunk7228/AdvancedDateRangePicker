 ...
 * @default 0 (Sunday)
 */
export declare const WEEK_STARTS_ON: 0;
/**
 ...
 * @default false
 */
export declare const CONSTRAIN_WEEK_TO_CURRENT_MONTH: false;
/**
 ...
 * @default true
 */
export declare const ALLOW_FUTURE_DATES: true;
/**
 * Week numbering mode
 ...
 */
export type WeekNumberingMode = "iso" | "jan1" | "firstFullWeek" | "calendarYearBased";
/**
 * Controls how week numbers are calculated and displayed in week view
 * @default "iso"
 */
export declare const WEEK_NUMBERING_MODE: WeekNumberingMode;
//# sourceMappingURL=dateConfig.d.ts.map